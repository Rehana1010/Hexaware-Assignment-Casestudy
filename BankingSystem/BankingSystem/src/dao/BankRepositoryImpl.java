...
public  class BankRepositoryImpl implements IBankRepository {
	...
	public void createAccount(Customer customer, long account_id, String account_type, float balance) {
		...
		try {
			// Assuming you have a table named 'Accounts' with columns 'account_id', 'AccountType', 'balance', and 'customer_id'
	...
	public void calculateInterest() {
		// TODO Auto-generated method stub
		try {
	        // Assuming you have a table named 'SavingsAccounts' with columns 'account_id', 'InterestRate'
	...
	public float getBalance(long account_id) {
		try {
	        // Assuming you have a table named 'Accounts' with columns 'account_id', 'balance'
	...
	public float withdraw(long account_id, float amount) {
		// TODO Auto-generated method stub
		try {
	        // Assuming you have a table named 'Accounts' with columns 'account_id', 'balance', 'AccountType'
	...
	private Customer getCustomerById(int customer_id) {
		try {
			// Assuming you have a table named 'Customers' with columns 'customer_id', 'first_name', 'last_name', 'email', 'phone_number', 'address', 'DOB'
			...
			try (PreparedStatement preparedStatement = con.prepareStatement(sql)) {
				...
				try (ResultSet resultSet = preparedStatement.executeQuery()) {
					if (resultSet.next()) {
						...
						long phone_number = resultSet.getLong("phone_number");
						String address = resultSet.getString("address");
						String DOB = resultSet.getString("DOB"); // Assuming DOB is stored as a Date type
	...
	public Account getAccount(long account_id) {
	    try {
	        String sql = "SELECT A.account_id, A.account_type, A.balance, C.customer_id, C.first_name, C.last_name, C.email, C.phone_number, C.address, C.DOB " +
	                     "FROM Accounts A JOIN Customers C ON A.customer_id = C.customer_id " +
	                     "WHERE A.account_id = ?";
	        ...
	        try (PreparedStatement statement = con.prepareStatement(sql)) {
	            ...
	            try (ResultSet resultSet = statement.executeQuery()) {
	                if (resultSet.next()) {
	                    ...
	                    return new Account(account_id, account_type, balance, new Customer(customer_id, first_name, last_name, email, phone_number, address, DOB));
	                } else {
	                    // Account not found
	                    return null;
	                }
	...
	void addTransaction(Transaction transaction) {
		try {
			// Assuming you have a table named 'Transactions' with columns 'account_id', 'Description', 'DateTime', 'TransactionType', 'TransactionAmount'
